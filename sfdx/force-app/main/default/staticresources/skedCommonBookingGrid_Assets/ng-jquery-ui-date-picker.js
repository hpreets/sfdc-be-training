	      ...
	      var initDateWidget = function initDateWidget() {
	        ...
	        if (controller) {
	          ...
	          controller.$validators.uiDateValidator = function uiDateValidator(modelValue, viewValue) {
	            return viewValue === null || viewValue === '' || _angular2.default.isDate(uiDateConverter.stringToDate(opts.dateFormat || attrs.uiDateFormat, viewValue));
	          };

	          controller.$parsers.push(function uiDateParser(valueToParse) {
	            return uiDateConverter.stringToDate(opts.dateFormat || attrs.uiDateFormat, valueToParse);
	          });
	          ...
	          controller.$render = function () {
	            ...
	            if (_angular2.default.isDate(controller.$modelValue) === false && _angular2.default.isString(controller.$modelValue)) {
	              controller.$modelValue = uiDateConverter.stringToDate(opts.dateFormat || attrs.uiDateFormat, controller.$modelValue);
	            }
